...
public class FundInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ft_speak_imgbtn = (ImageButton) view.findViewById(R.id.ft_speak_imgbtn);
        ...
        ft_gone_ll_txt_img = (LinearLayout) view.findViewById(R.id.ft_gone_ll_txt_img);
        ...
        reciverUn.setText(bundle.getString("nameBenificiary") + " (Beneficiary)");
...
//                getActivity().startActivity(new Intent(getContext(), ErrorDialogActivity.class));
                ...
                if (fiClienttPin.getText().toString().equals("")) {
                    fiClienttPin.setError("This field is empty");
                }
            } else {
                if (BenificiaryaccNo.getText().toString().equals(bundle.getString("codeBenificiary"))) {
                    if (ft_gone_ll_txt_img.getVisibility() == View.GONE) {
                        ft_gone_ll_txt_img.setVisibility(View.VISIBLE);
        ...
        call.enqueue(new Callback<WithDrawlResponse>() {
            ...
            public void onResponse(Call<WithDrawlResponse> call, Response<WithDrawlResponse> response) {
                ...
                if (String.valueOf(response.code()).equals("200")) {
                    ...
                    ft_gone_ll_txt_img.setVisibility(View.GONE);
