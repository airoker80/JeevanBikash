...
public class MainPrinterActivity extends ListActivity {
	String printMsg = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		printMsg = getIntent().getStringExtra("printMsg");
		...
		mhandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case MESSAGE_READ:
					...
					break;
				case MESSAGE_STATE_CHANGE:// 蓝牙连接状  Bluetooth connection like
					switch (msg.arg1) {
					case PrinterClass.STATE_CONNECTED:// 已经连接 Already connected
						break;
					case PrinterClass.STATE_CONNECTING:// 正在连接 connecting
					...
					case PrinterClass.SUCCESS_CONNECT:
						PrintService.pl().write(new byte[] { 0x1b, 0x2b });// 检测打印机型号 Detect the printer model
						Toast.makeText(getApplicationContext(),
					...
					case PrinterClass.FAILED_CONNECT:
						...
						if (BlueToothService.autoConnect == 3) {
							startActivity(new Intent(MainPrinterActivity.this,
...
//					Stop scanning
							...
							public void run() {
								...
								if (PrintService.pl() != null) {
									if (PrintService.pl().getState() == PrinterClass.STATE_CONNECTED) {
										textView_state
												.setText(MainPrinterActivity.this
														.getResources()
														.getString(
										...
										intent.setClass(MainPrinterActivity.this,
	...
	protected void onListItemClick(ListView listView, View v, int position,
		...
		MainPrinterActivity.checkState = true;
		Intent intent = new Intent();
		intent.putExtra("position", position);
		intent.putExtra("printMsg", printMsg);
		intent.setClass(MainPrinterActivity.this, PrintActivity.class);
